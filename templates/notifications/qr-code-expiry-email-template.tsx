		...
		<Html>
			...
			<Tailwind>
				<Body className="mx-auto my-auto bg-gray-50 font-sans">
					<Container className="mx-auto my-10 max-w-[500px] rounded-lg border border-gray-300 border-solid bg-white px-8 py-6 shadow-lg">
						<Section>
							<Img
								src={LEAPER_WORKMARK}
								height="200"
						...
						<Heading className="mt-6 mb-4 text-center font-bold text-2xl text-gray-800">
							QR Code Expired
						</Heading>
						<Text className="mb-4 text-center text-gray-700 text-sm leading-6">
							Your QR code has expired as of:
						</Text>
						<Text className="mb-6 text-center font-semibold text-lg text-red-600">
							{formatDateToLocal(expirationDate)}
						</Text>
						<Text className="mb-6 text-center text-gray-700 text-sm leading-6">
