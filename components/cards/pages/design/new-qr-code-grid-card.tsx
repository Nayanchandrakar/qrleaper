...
export const NewQrCodeGridCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1 border-t border-gray-100 bg-white px-4 py-5 text-center">
        <h4 className="text-base font-semibold transition duration-200 group-hover:text-green-600">
          {title}
        </h4>
        <p className="group-hover:text text-sm font-medium text-gray-500 transition duration-200">
          {description}
        </p>
      </div>
    </Link>
