...
const groupDataByDate = (data: qrAnayticsType[]) => {
  const groupedData = new Map<
    string,
    { date: string; desktop: number; mobile: number; other: number }
  >()
...
const calculateTotals = (
  data: { desktop: number; mobile: number; other: number }[]
) => {
...
const DeviceAnalyticsChart = ({
  ...
  const formattedDeviceData = React.useMemo(() => groupDataByDate(data), [data])
